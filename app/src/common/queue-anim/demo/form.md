...
````jsx
import { QueueAnim, Button, Radio, Input, Form, Row, Col } from 'jgui';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <QueueAnim component={Form} className="jgui-form jgui-form-horizontal" type="bottom" leaveReverse>
          {this.state.show ? [
            <FormItem key="item1" {...formItemLayout} label="用户名：">
              <p className="jgui-form-text">大眼萌 minion</p>
            </FormItem>,
