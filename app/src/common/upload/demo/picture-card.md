...
````jsx
import { Upload, Icon, Modal } from 'jgui';
  ...
  render() {
    ...
    return (
      <div className="clearfix">
        <Upload {...props}>
          <Icon type="plus" />
          <div className="jgui-upload-text">上传照片</div>
        </Upload>
...
````css
/* 配合样式可以做出上传按钮和示例效果 */
.jgui-upload-select-picture-card i {
  font-size: 28px;
  color: #999;
}

.jgui-upload-select-picture-card .jgui-upload-text {
  margin-top: 8px;
  font-size: 12px;
  color: #666;
}
