...
| locale              | 国际化配置 | Object | [默认配置](https://github.com/jgui-design/jgui-design/issues/1270#issuecomment-201181384) |

<style>.code-box-demo .jgui-time-picker { margin: 0 8px 12px 0; }</style>
