...
export default function confirm(config) {
    ...
    let body = (
        <div className="jgui-confirm-body">
            <Icon type={props.iconType}/>
            <span className="jgui-confirm-title">{props.title}</span>
            <div className="jgui-confirm-content">{props.content}</div>
        </div>
    );
    ...
    if (props.okCancel) {
        footer = (
            <div className="jgui-confirm-btns">
