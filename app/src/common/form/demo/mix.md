...
集中营，展示和表单相关的其他 jgui-design 组件。

````jsx
import { Form, Select, InputNumber, DatePicker, TimePicker, Switch, Radio,
         Cascader, Slider, Button, Col, Upload, Icon } from 'jgui';
    ...
    return (
      <Form horizontal onSubmit={this.handleSubmit} >
        ...
        >
          ...
          />
          <span className="jgui-form-text"> 台机器</span>
        </FormItem>
        ...
        <FormItem
          ...
          wrapperCol={{ span: 10 }}
        >
          <p className="jgui-form-text" id="static" name="static">唧唧复唧唧木兰当户织呀</p>
          <p className="jgui-form-text">
            <a href="#">链接文字</a>
          </p>
        </FormItem>
